...
data = pd.read_pickle("reg/bridge-abccomp-corr_random.pkl.gz")
...
plt.savefig("plt/bridge-abccomp-regression_first.png")
plt.show()
...
df.to_pickle("reg/bridge-abccomp-best_s1.pkl.gz")
df
